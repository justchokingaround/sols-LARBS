# **WIP** Luke's Auto-Rice Bootstrapping Scripts (LARBS) (Sols' editon)
...
```
curl -LO https://raw.githubusercontent.com/Sols-thiem/LARBS/master/larbs.sh
sh larbs.sh
```

That's it.
## What's different than the default one?
